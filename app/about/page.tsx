    ...
    <StoreLayout>
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose max-w-none">
          ...
          <p className="mb-6">
          uestra misión en Nutrimaxiboost es brindar productos de alta calidad que impulsen el rendimiento físico, fortalezcan la salud y promuevan el bienestar integral de nuestros clientes. Nos enfocamos en acompañarlos en cada paso hacia sus metas fitness, ofreciendo suplementos confiables, seguros y eficaces que se adaptan a su estilo de vida.
          ...
          <ul> <li>🔶 <strong>Compromiso con la calidad:</strong> Seleccionamos cuidadosamente cada producto, garantizando su eficacia, seguridad y durabilidad para apoyar la salud y el rendimiento físico de nuestros clientes.</li> 
          ...
          <li>🎧 <strong>Excelencia en la atención al cliente:</strong> Brindamos un servicio cercano, empático y personalizado para asegurar una experiencia de compra memorable.
          </li> </ul>
          </ul>
